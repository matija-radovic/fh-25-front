...
const Path = memo(forwardRef<PathRef, PathProps>(({ fill, d, ...props }, ref) => {
    ...
    return <path ref={pathRef} className="path" d={d} style={{ '--fill-color': fill } as React.CSSProperties} {...props} />;
}));
